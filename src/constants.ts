...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    playOrSing: 'Play or say',
    playThisNote: 'Play or say this note',
    activateMic: 'Activate',
    detected: 'Detected',
    ...
    selectInputMode: 'Input Method',
    inputModeKeyboard: 'Computer Keyboard',
    inputModeMidi: 'MIDI Keyboard',
    inputModeMicrophone: 'Microphone',
    inputModeVoice: 'Voice Recognition',
    inputModeVirtualKeyboard: 'On-Screen Piano',
  ...
  ru: {
    ...
    playOrSing: 'Сыграйте или скажите',
    playThisNote: 'Сыграйте или скажите эту ноту',
    activateMic: 'Активировать',
    detected: 'Обнаружено',
    ...
    selectInputMode: 'Метод ввода',
    inputModeKeyboard: 'Клавиатура ПК',
    inputModeMidi: 'MIDI клавиатура',
    inputModeMicrophone: 'Микрофон',
    inputModeVoice: 'Голосовой ввод',
    inputModeVirtualKeyboard: 'Экранное пианино',
  ...
  uk: {
    ...
    playOrSing: 'Зіграйте або скажіть',
    playThisNote: 'Зіграйте або скажіть цю ноту',
    activateMic: 'Активувати',
    detected: 'Виявлено',
    ...
    selectInputMode: 'Метод вводу',
    inputModeKeyboard: 'Клавіатура ПК',
    inputModeMidi: 'MIDI клавіатура',
    inputModeMicrophone: 'Мікрофон',
    inputModeVoice: 'Голосове введення',
    inputModeVirtualKeyboard: 'Екранне піаніно',
  ...
  et: {
    ...
    playOrSing: 'Mängi või ütle',
    playThisNote: 'Mängi või ütle see noot',
    activateMic: 'Aktiveeri',
    detected: 'Tuvastatud',
    ...
    selectInputMode: 'Sisendseade',
    inputModeKeyboard: 'Arvuti klaviatuur',
    inputModeMidi: 'MIDI klaviatuur',
    inputModeMicrophone: 'Mikrofon',
    inputModeVoice: 'Häältuvastus',
    inputModeVirtualKeyboard: 'Ekraaniklaver',
