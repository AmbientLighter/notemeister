    ...
    return (
        <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="bg-indigo-50 dark:bg-indigo-900/30 p-4 rounded-3xl transition-colors duration-200">
                ...
                <div className="text-[10px] text-indigo-400 dark:text-indigo-300 font-bold uppercase mt-1 tracking-wider">{t.correct}</div>
            </div>
            <div className="bg-emerald-50 dark:bg-emerald-900/30 p-4 rounded-3xl transition-colors duration-200">
                ...
                <div className="text-[10px] text-emerald-400 dark:text-emerald-300 font-bold uppercase mt-1 tracking-wider">{t.accuracy}</div>
            </div>
            <div className="bg-orange-50 dark:bg-orange-900/30 p-4 rounded-3xl transition-colors duration-200">
                ...
                <div className="text-[10px] text-orange-400 dark:text-orange-300 font-bold uppercase mt-1 tracking-wider">{t.streak}</div>
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-3xl transition-colors duration-200">
                ...
                <div className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase mt-1 tracking-wider">{t.avgTime}</div>
            </div>
        </div>
    );
};
