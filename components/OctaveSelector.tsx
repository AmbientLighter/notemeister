...
const OctaveSelector: React.FC = () => {
    ...
    return (
        <div className="mb-8">
            <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 uppercase tracking-widest">{t.selectOctaves}</label>
                ...
                {OCTAVE_RANGES[settings.clef].map(octave => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-14 h-14 rounded-2xl font-bold text-xl flex items-center justify-center transition-all duration-300 border-2 transform active:scale-90 ${status === 'full'
